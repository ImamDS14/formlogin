                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            ...
                            <div class="row m-t-30">
                                <div class="col-md-12">
                                    <button type="submmit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">LOGIN</button>
                                </div>
                            </div>
                            <hr/>
                            <div class="row">
                                <div class="col-md-10">
                                    <p  class="text-inverse text-left m-b-0">Already have an account? <a href="{{route('register')}}"><b>Register</b></a></p>
                                </div>
